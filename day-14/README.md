...
You reach the place where all of the mirrors were pointing: a massive _[parabolic reflector dish](https://en.wikipedia.org/wiki/Parabolic_reflector)_ attached to the side of another large mountain.
...
The parabolic reflector dish deforms, but not in a way that focuses the beam. To do that, you'll need to move the rocks to the edges of the platform. Fortunately, a button on the side of the control panel labeled **_"spin cycle"_** attempts to do just that!
